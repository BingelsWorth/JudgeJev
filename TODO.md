...
- `npm test`: 148/148 passing across `test/contracts.test.ts`, `test/jev-client.test.ts`, `test/routing-errors.test.ts`, `test/providers.test.ts`, `test/e2e.test.ts`, `test/judge.test.ts`, `test/proxy.test.ts`.
